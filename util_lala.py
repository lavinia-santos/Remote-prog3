...
def calculate_dihedral_angle_gradient(file,atom_coords, bonds,atom_types):
    ...
    torsion_angles, chains_of_four = calculate_torsion_angle(atom_coords, bonds, atom_types)
...
def debug(file_name):
    ...
    dihedral_angle_gradient = calculate_dihedral_angle_gradient(file_name,atom_coords, bonds, atom_types)
